...
$username_err = $password_err = $login_err = $usertype_err = "";
$admin = 1;
$secretary = 2;
...
<body>
    ...
    <div class="row">
        <div class="col-lg d-flex justify-content-center">
            <img class="img-fluid mx-auto d-block" src="https://i.imgur.com/0gfEfHt.jpg" alt="" srcset="">
        </div>
        <div class="col-sm">
        <div class="wrapper">
        <h2>Login</h2>
