  ...
  <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active fw-bold" aria-current="page" href="employee_list_admin.php">Employee List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="reports.php">Reports</a>
        </li>
        <li class="nav-item">
          <a class="nav-link"  href="accomplishments.php">Accomplishment</a>
        </li>
...
<div class="container">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add new Employee <i class="fa-solid fa-plus"></i></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            
        </div>
        <form action="" method="post">
        <div class="modal-body">
                <p class="d-flex"><b>Note: Employee ID must be unique.</b></p>
                <div class="form-group mb-2">
                    <input type="text" class="form-control form-control-sm" name="employeeid" placeholder="Employee ID">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    <input type="text" class="form-control form-control-sm" name="birthday" placeholder="Birthday">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    <input type="text" class="form-control form-control-sm" name="salary" placeholder="Salary">
                </div>
                <div class="form-group">
                <button type="submit" name="submit" class='btn btn-sm btn-danger'><i class="fas fa-save"></i> Save</button>
                </div>
        </div>
        </form>
        </div>
           ...
           echo  "<thead>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    ...
                    <td>".$row["salary"]."</td>
                    <td>
                        <button class='btn btn-sm btn-secondary'><a href=edit_employee_admin.php?id=".$row["id"]." ?>Edit</a></button>
                        <button class='btn btn-sm btn-danger' name='delete'><a href=delete_employee_admin.php?id=".$row["id"]." ?>Delete</a></button>
                    </td>
                </tr>
                </tbody>";
            }
